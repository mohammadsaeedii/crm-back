...
const tenant_host_guard_1 = require("./tenant-host.guard");
...
exports.TenantsModule = TenantsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tenants_service_1.TenantsService, tenant_host_guard_1.TenantHostGuard],
        exports: [tenants_service_1.TenantsService, tenant_host_guard_1.TenantHostGuard],
    })
], TenantsModule);
